...
if isProj==0
    ...
    set(gcf, 'visible', 'on');
    xlabel(['Ice Thickness Mean on 2003-2008',' March ',configuration, ' Degree'],'fontweight','bold','fontsize',12,'fontname','Nimbus Sans L');
    print(gcf, '-dpng', '-r300' ,['Ice_Thickness_mean_2003-2008_','March_',configuration,'_Degree','.png']);
