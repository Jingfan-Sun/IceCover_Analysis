...
for yearCounter = 2003:2008
    ...
    timeCounter = 60; % don't forget to change
    disp(yearCounter);
end

total_Area_Sum = total_Area_Sum / 1e6; % change the unit from m^2 to km^2
total_Area_Mean_12 = total_Area_Sum / day_Num / 6;
...
total_Area_Sum = total_Area_Sum / 1e6; % change the unit from m^2 to km^2
total_Area_Mean_4 = total_Area_Sum / day_Num / 6;

total_Area_Mean = total_Area_Mean_12 - total_Area_Mean_4;
...
%% Output
set(gcf, 'visible', 'on');
title(['Ice Thickness Distribution Diff over 2003-2008',' March '],'fontweight','bold','fontsize',12,'fontname','Nimbus Sans L');
xlabel('Ice Thickness \m');
xlabh = get(gca,'XLabel');
set(xlabh,'Position',get(xlabh,'Position') + [0 22000 0]); % September 17000; March 22000
ylabel('Area \km^2');
set(gca, 'Position', [0.13 0.085 0.775 0.815]);
title=get(gca, 'Title');
set(title, 'Position', get(title, 'Position') + [0 5000 0]); % September 4000; March 5000
print(gcf, '-dpng', '-r300' ,['Ice_Thickness_Distribution_Diff_2003-2008_','March.png']);
