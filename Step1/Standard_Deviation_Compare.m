...
std_Result_12 = sqrt(temp_Sum / 5); % STD here use normalization N-1
...
disp('square finished');
std_Result_4 = sqrt(temp_Sum / 5); % STD here use normalization N-1
...
hp=m_pcolor(navLon,navLat,std_Result_12(1:3:2398, 1:3:1630) - std_Result_4);set(hp,'linestyle','none');
...
set(gca, 'CLim', [-0.4, 0.4]); % ice thickness -0.4-0.4 \\\ ice concentrstion -0.3-0.3 
set(hbar,'position',[0.9 0.1055 0.02 0.8203]);

%% Output
set(gcf, 'visible', 'on');
xlabel(['Ice Thickness STD Diff on 2003-2008',' September'],'fontweight','bold','fontsize',12,'fontname','Nimbus Sans L');
print(gcf, '-dpng', '-r300' ,['Ice_Thickness_STD_Diff_2003-2008_','September','.png']);