...
%% Output
title('Satellite','fontweight','bold','fontsize',8,'fontname','Nimbus Sans L');
...
%% Output
title('ANHA12','fontweight','bold','fontsize',8,'fontname','Nimbus Sans L');
...
print(gcf, '-dpng', '-r300' ,['Ice_Thickness_Sat_Distribution_Compare_ON_03_04_05_06_07.png']);
