...
yearCounter = 2003;
flag = 1; % control the configuration: 1 for 4th, 0 for 12th
...
if isProj==0
    ...
    hp=m_pcolor(navLon,navLat,ice_Mean);set(hp,'linestyle','none');
    ...
    set(gca, 'CLim', [0,5.0]); % ice thickness 0-5.0 \\\ ice concentrstion 0-1.0
    set(hbar,'position',[0.9 0.1055 0.02 0.8203]);
    
    set(gcf, 'visible', 'on');
    xlabel(['Ice Thickness Mean on 2003-2010',' March ',configuration, ' Degree'],'fontweight','bold','fontsize',12,'fontname','Nimbus Sans L');
    print(gcf, '-dpng', '-r300' ,['Ice_Thickness_mean_2003-3010_','March_',configuration,'_Degree','.png']);
