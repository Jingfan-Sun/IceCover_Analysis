...
for i = 1:10
    ...
    plotting = [];
    for j = 1: numel(total_Area_Sum)
        temp_plot = (ones(1, round(total_Area_Sum(j)))*2*j - 1) / 10;
    ...
    %% Output
    title(['Satellite ', name_Array{i}],'fontweight','bold','fontsize',8,'fontname','Nimbus Sans L');
    ...
    %% Output
    title(['ANHA4 ', name_Array{i}],'fontweight','bold','fontsize',8,'fontname','Nimbus Sans L');
    ylabel('Area \km^2', 'fontweight','bold','fontsize',8,'fontname','Nimbus Sans L');
    % set(gcf, 'visible', 'on');
    ...
    %% Output
    title(['ANHA12 ', name_Array{i}],'fontweight','bold','fontsize',8,'fontname','Nimbus Sans L');
    ...
    print(gcf, '-dpng', '-r300' ,['Ice_Thickness_Sat_Distribution_Compare_', name_Array{i}, '.png']);
end
