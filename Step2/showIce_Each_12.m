...
for yearCounter = 2007
    ...
    for i = 1:day_Num
        ...
        if isProj==0
            ...
            set(gcf, 'visible', 'on');
            xlabel(['Ice Thickness on ', date, ' ', configuration, ' Degree'],'fontweight','bold','fontsize',12,'fontname','Nimbus Sans L');
            print(gcf, '-dpng', '-r300' ,['Ice_Thickness_', date, '_', configuration,'_Degree','.png']);
