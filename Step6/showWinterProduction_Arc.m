function showWinterProduction_Arc(YS,YE,monSelect,varargin)
...
if isProj==0
  ...
  %m_proj('stereographic','latitude',90,'radius',55,'rotangle',45,'rect','on');
  m_proj('stereographic','latitude',90,'radius',45,'rotangle',45);
...
print(gcf, '-dpng', '-r300', ['iceP_vs_totalIceHChange_Arc_',num2str(YS),'_',monStr,'.png']);

if isSave==1
   maxWIN;
   eval(['print -dpng -r300 iceP_vs_totalIceHChange_Arc_',num2str(YS),'_',monStr,'.png'])
else
   disp(['print -dpng -r300 iceP_vs_totalIceHChange_Arc_',num2str(YS),'_',monStr,'.png'])
end
