...
%     end
    ...
    plot(distance_X, ANHA4_range_down, '--b', 'LineWidth', 0.7);
    plot(distance_X, ANHA4_range_up, '--b', 'LineWidth', 0.7);
...
%     end
    ...
    print(gcf, '-dpng' ,'-r300',['AIR-EM_summaries_2001_2009_v1_', campaign_Name{i}, '_curve.png']);
end
