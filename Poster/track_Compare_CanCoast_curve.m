...
%     m_line(lon(campaign_Index(i)), lat(campaign_Index(i)), 'Color', 'g', 'LineStyle', '*', 'LineWidth', 4);
%     
...
%     end
    ...
    print(gcf, '-dpng' ,'-r300',['CanCoast_summaries_1947_2010_v1_', campaign_Name{i}, '_curve.png']);
end
