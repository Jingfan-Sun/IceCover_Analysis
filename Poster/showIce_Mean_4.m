...
day_Num = 12; % Sept 6, March 7, Feb and Mar 12, Oct and Nov 12
...
if isProj==0
    ...
    set(gca, 'CLim', [0, 4.0]); % ice thickness 0-4.0 \\\ ice concentrstion 0-0.8
    set(hbar,'position',[0.9 0.1055 0.02 0.8203]);
    
    set(gcf, 'visible', 'on');
    xlabel(['Ice Thickness Mean 2003-2007 Oct and Nov ',configuration, ' Degree'],'fontweight','bold','fontsize',12,'fontname','Nimbus Sans L');
    print(gcf, '-dpng', '-r300' ,['Ice_Thickness_mean_Oct_Nov_',configuration,'_Degree','.png']);
