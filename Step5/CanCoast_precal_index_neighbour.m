...
for yearCounter = 2002: 2010
    ...
    for timeCounter = 5: 5: 365
        ...
        iceL=GetNcVar(ncfile,'ileadfra',[subII(1)-1 subJJ(1)-1 0],[numel(subII) numel(subJJ) 1]);
        ...
        for jj = 1: 8
            ...
            for kk = 1: 9
                if(inverseDistance_all(jj, kk) ~= 0)
                    ...
                    point_iceL = point_iceL + iceL(neighbour_Index_12(jj, kk)) * inverseDistance_all(jj, kk) / sum_Distance;
            ...
            IceL_all(jj, (timeCounter / 5 + (yearCounter - 2002) * 365/5)) = point_iceL;
