...
close all;
%% Read data
D = importdata('../Step3/unified-sea-ice-thickness-cdr-1947-2012/IceBridge_summaries_2009_2011_v1.txt');
...
for i = 1:2
    ...
    p1 = plot(distance_X, track_Ice', '-', 'LineWidth', 1,'Color', [0 0 0] );
    ...
    hold on;
    p2 = plot(distance_X, track_ANHA12, '-r', 'LineWidth', 1);
    ...
    hold on;
    p3 = plot(distance_X, track_G, '-g', 'LineWidth', 1);
    grid on;
    set(gca,'fontweight','bold','fontsize',7,'fontname','Nimbus Sans L');
    ...
    legend([p1 p2 p3], 'Observation', 'ANHA12', 'GLORYS2V3', 'Location', 'NorthEast');
    ...
    disp(['GLORYS2V3 finished ', num2str(i)]);
    %% Map plot
    subplot(212);
    ...
    if(radius == 10)
        ...
        m_line(lon_Temp, lat_Temp, 'linewi',1.3, 'Color', 'g');
    end
    for j = 1: (campaign_Index(i + 1) - campaign_Index(i))
...
%     end
    ...
    print(gcf, '-dpng' ,'-r300',['IceBridge_summaries_2009_2011_v1_', campaign_Name{i}, '.png']);
end
