...
close(gcf);
%% Read data
D = importdata('unified-sea-ice-thickness-cdr-1947-2012/BIO_LS_summaries_2003_2007_v1.txt');
[row, col] = size(D.data);
...
title = title('BIO_LS_summaries_2003_2007_v1', 'fontweight','bold','fontsize',12,'fontname','Nimbus Sans L');
set(title,'Interpreter','none');

print(gcf, '-dpng', '-r300' ,'BIO_LS_summaries_2003_2007_v1.png');
