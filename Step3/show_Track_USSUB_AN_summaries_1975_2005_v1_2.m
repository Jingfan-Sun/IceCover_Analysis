...
close(gcf);
%% Read data
D = importdata('unified-sea-ice-thickness-cdr-1947-2012/USSUB-AN_summaries_1975_2005_v1_2.txt');
[row, col] = size(D.data);
...
title = title('USSUB-AN_summaries_1975_2005_v1_2', 'fontweight','bold','fontsize',12,'fontname','Nimbus Sans L');
set(title,'Interpreter','none');

print(gcf, '-dpng', '-r300' ,'USSUB-AN_summaries_1975_2005_v1_2.png');
