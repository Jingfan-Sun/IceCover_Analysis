...
close(gcf);
%% Read data
D = importdata('unified-sea-ice-thickness-cdr-1947-2012/Davis_St_summaries_2006_2008_v1.txt');
[row, col] = size(D.data);
...
title = title('Davis_St_summaries_2006_2008_v1', 'fontweight','bold','fontsize',12,'fontname','Nimbus Sans L');
set(title,'Interpreter','none');

print(gcf, '-dpng', '-r300' ,'Davis_St_summaries_2006_2008_v1.png');
