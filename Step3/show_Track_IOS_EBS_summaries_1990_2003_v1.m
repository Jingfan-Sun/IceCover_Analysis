...
close(gcf);
%% Read data
D = importdata('unified-sea-ice-thickness-cdr-1947-2012/IOS-EBS_summaries_1990_2003_v1.txt');
[row, col] = size(D.data);
...
title = title('IOS-EBS_summaries_1990_2003_v1', 'fontweight','bold','fontsize',12,'fontname','Nimbus Sans L');
set(title,'Interpreter','none');

print(gcf, '-dpng', '-r300' ,'IOS-EBS_summaries_1990_2003_v1.png');
