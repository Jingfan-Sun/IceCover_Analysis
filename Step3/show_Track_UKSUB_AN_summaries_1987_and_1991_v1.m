...
close(gcf);
%% Read data
D = importdata('unified-sea-ice-thickness-cdr-1947-2012/UKSUB-AN_summaries_1987_and_1991_v1.txt');
[row, col] = size(D.data);
...
title = title('UKSUB-AN_summaries_1987_and_1991_v1', 'fontweight','bold','fontsize',12,'fontname','Nimbus Sans L');
set(title,'Interpreter','none');

print(gcf, '-dpng', '-r300' ,'UKSUB-AN_summaries_1987_and_1991_v1.png');
