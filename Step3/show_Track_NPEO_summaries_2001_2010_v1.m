...
close(gcf);
%% Read data
D = importdata('unified-sea-ice-thickness-cdr-1947-2012/NPEO_summaries_2001_2010_v1.txt');
[row, col] = size(D.data);
...
title = title('NPEO_summaries_2001_2010_v1', 'fontweight','bold','fontsize',12,'fontname','Nimbus Sans L');
set(title,'Interpreter','none');

print(gcf, '-dpng', '-r300' ,'NPEO_summaries_2001_2010_v1.png');
