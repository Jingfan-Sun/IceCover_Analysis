...
%    text(x, y, num2str(i), 'Color', 'r', 'FontSize', 6, 'fontweight','bold', 'fontname','Nimbus Sans L');
   hleg1 = text(0.7,(0.6 - room*i), [num2str(i), ' ', campaign_Name{i}], 'Color', color_Temp, 'FontSize', 8, 'fontweight','bold', 'fontname','Nimbus Sans L');
...
title = title('IceBridge_summaries_2009_2011_v1', 'fontweight','bold','fontsize',12,'fontname','Nimbus Sans L');
set(title,'Interpreter','none');

print(gcf, '-dpng', '-r300' ,'IceBridge_summaries_2009_2011_v1.png');
