...
close(gcf);
%% Read data
D = importdata('unified-sea-ice-thickness-cdr-1947-2012/ICESAT1-G_summaries_2005_2007_v1.txt');
[row, col] = size(D.data);
...
title = title('ICESAT1-G_summaries_2005_2007_v1', 'fontweight','bold','fontsize',12,'fontname','Nimbus Sans L');
set(title,'Interpreter','none');

print(gcf, '-dpng', '-r300' ,'ICESAT1-G_summaries_2005_2007_v1.png');
