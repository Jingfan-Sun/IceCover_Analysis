...
close(gcf);
%% Read data
D = importdata('unified-sea-ice-thickness-cdr-1947-2012/BGEP_summaries_2003_2012_v1.txt');
[row, col] = size(D.data);
...
%% Plot track
m_proj('stereographic','latitude',90,'radius',35,'rotangle',45, 'rect', 'on');
m_grid;
disp('grid finish');
...
for i = 1:length-1
   ...
   hleg1 = text(0.65,(0.6 - room*i), [num2str(i), ' ', campaign_Name{i}, ' ', num2str(campaign_Year(i))], 'Color', color_Temp, 'FontSize', 8, 'fontweight','bold', 'fontname','Nimbus Sans L');
...
title = title('BGEP_summaries_2003_2012_v1', 'fontweight','bold','fontsize',12,'fontname','Nimbus Sans L');
set(title,'Interpreter','none');

print(gcf, '-dpng', '-r300' ,'BGEP_summaries_2003_2012_v1.png');
