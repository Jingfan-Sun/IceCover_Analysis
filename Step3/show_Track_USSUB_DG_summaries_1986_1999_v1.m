...
close(gcf);
%% Read data
D = importdata('unified-sea-ice-thickness-cdr-1947-2012/USSUB-DG_summaries_1986_1999_v1.txt');
[row, col] = size(D.data);
...
title = title('USSUB-DG_summaries_1986_1999_v1', 'fontweight','bold','fontsize',12,'fontname','Nimbus Sans L');
set(title,'Interpreter','none');

print(gcf, '-dpng', '-r300' ,'USSUB-DG_summaries_1986_1999_v1.png');
